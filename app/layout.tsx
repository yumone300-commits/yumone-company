...
openGraph:{title:share.title,description:share.description,url:site.url,siteName:site.name,locale:'ko_KR',type:'website',images:[{url:share.image,width:1200,height:630,alt:share.imageAlt}]},
