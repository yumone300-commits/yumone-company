export const site = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://yumone-growth-partner.fairy-betta-3508.chatgpt.site',
  ...
  phone: '', email: '', address: '', businessNumber: '', logo: '', ceoPhoto: '/images/yeom-hyedan.jpg',
  privacyOfficer: '', retentionPeriod: '', careers: [] as string[], achievements: [] as string[],
};
export const nav = [{label:'회사소개',href:'/about'},{label:'사업분야',href:'/services'},{label:'교육프로그램',href:'/education'},{label:'성공사례',href:'/cases'},{label:'인사이트',href:'/insights'}];
